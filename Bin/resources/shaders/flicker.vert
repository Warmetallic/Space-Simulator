...
{	
	...
	if (fIntensity<0.5) {
	vColour = vec3(0,0.1,0) + diffuseColour + specularColour;
	}

	if (fIntensity>0.5 && fIntensity<0.75) {
	vColour = vec3(0,0.5,0) + diffuseColour + specularColour;
	}

	if (fIntensity>0.75) {
	vColour = vec3(0,1,0) + diffuseColour + specularColour;
	}
} 
