...
{	
	...
	BlinnPhongSpotlightModel(light1,p,n);
	BlinnPhongSpotlightModel(light2,p,n);
	BlinnPhongSpotlightModel(light3,p,n);	

	// Apply the Phong model to get the colour at this vertex. 
	vColour = BlinnPhongSpotlightModel(light2,p,n)+BlinnPhongSpotlightModel(light1,p,n)+BlinnPhongSpotlightModel(light3,p,n);
} 
